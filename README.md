...
wget https://github.com/LORDINFINITY12/case-organizer-v3/releases/download/v4.1.0/case-organizer_4.1.0_all.deb

# Install the package
sudo dpkg -i case-organizer_4.1.0_all.deb
...
**Current Release:** v4.1.0 (March 2026)
